...
public class SeleniumBasics_DuplicateLead {
...
System.out.println("The Automation Testing Started");
		...
		System.out.println("Setting up the driver for chrome browser");
				...
				System.out.println("Started Assignment 3");
				...
				WebElement selectedoption = SDD.getFirstSelectedOption();
				...
				WebElement DLead = driver.findElement(By.linkText("Duplicate Lead"));
				DLead.click();
				System.out.println("Clicked on Duplicate Lead Button");
				
				//Clear Company name and enter new company name
				WebElement OldCompname = driver.findElement(By.id("createLeadForm_companyName"));
				OldCompname.clear();
				System.out.println("Old Company name Cleared");
				
				//Enter new company name
				WebElement NewCompname = driver.findElement(By.id("createLeadForm_companyName"));
				NewCompname.sendKeys("New Company name");
				System.out.println("New Company name Entered");
				
				//Clear Firstname and enter new Firstname
				WebElement OldFname = driver.findElement(By.id("createLeadForm_firstName"));
				OldFname.clear();
				System.out.println("Old Firstname entered");
				
				
				//Enter New First name
				WebElement NewFname = driver.findElement(By.id("createLeadForm_firstName"));
				NewFname.sendKeys("Krishna");
				System.out.println("New Firstname entered");
				
				
				//Click on create button:
				WebElement S1button = driver.findElement(By.name("submitButton"));
				S1button.click();
				System.out.println("Clicked on create Lead");
				...
				System.out.println("Successfully Completed Assignment 3");
